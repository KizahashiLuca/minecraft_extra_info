...
execute if entity @p[tag=MEI_Calculating,predicate=mei:system/biome/ocean/deep_warm_ocean] run data modify storage mei:storage actionbar.biome set value '["",{"text":"Deep Warm Ocean","color":"green","bold":true}]'
