...
execute if entity @p[tag=MEI_Calculating,predicate=mei:system/biome/temperate_1/old_growth_birch_forest] run data modify storage mei:storage actionbar.biome set value '["",{"text":"Old Growth Birch Forest","color":"green","bold":true}]'