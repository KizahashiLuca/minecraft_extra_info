...
execute if entity @p[tag=MEI_Calculating,predicate=mei:system/biome/mountains/cherry_grove] run data modify storage mei:storage actionbar.biome set value '["",{"translate":"biome.minecraft.cherry_grove","color":"green","bold":true}]'